...
<head>
    ...
    <title>Créer un compte | Viore Digital</title>
    ...
    <style>
        ...
        @media (max-width: 576px) {
            ...
            .shape { display: none; } /* Hide floating shapes on mobile for cleaner look */
        }
    </style>
</head>
    ...
    <div class="auth-wrapper">
        <div class="glass-card">
            ...
            <div class="header-section">
                <h2 class="welcome-title">Rejoignez-nous</h2>
                <p class="welcome-subtitle">Créez votre compte Slims 👋</p>
            </div>
